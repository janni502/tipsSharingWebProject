<head>
	...
	<style type="text/css">
		...
		.menu {text-align: left; font:  100% arial, verdana, sans-serif;
			font-weight: bold;}
		.morlink, .footer {text-align: right; font: 65% arial, verdana, sans-serif}
		.morlink {color: #993300}
		.footer {color: #000000; text_align:center;}
		.byline {text-align: left; font: 100% arial, verdana, sans-serif;
			font-weight: bold;}
	</style>
</head>
